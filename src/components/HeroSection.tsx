...
const HeroSection = () => {
  ...
  const handleExploreBlueCarbon = () => {
    ...
    window.open('https://newss2-eight.vercel.app/login', '_blank');
  };

  const handleLearnMore = () => {
    // Scroll to next section or show more information
        ...
        <div className="max-w-4xl px-6 text-center text-white">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <ShinyButton 
              ...
              onClick={handleExploreBlueCarbon}
            >
              Explore Blue Carbon
            </ShinyButton>
            <button 
              className="rounded-full border border-white/30 px-8 py-4 text-lg font-medium text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-white/50"
